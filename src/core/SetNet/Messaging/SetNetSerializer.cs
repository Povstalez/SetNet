...
namespace SetNet.Messaging
{
    ...
    {
        /// <summary>
        /// Registers the serializer on <see cref="SetNetRuntime.Default"/>. Prefer a scoped
        /// <see cref="SetNetRuntime"/> on <c>Configuration.Runtime</c> when one process hosts multiple independent
        /// clients/servers.
        /// </summary>
        ...
        public static void Use(ISerializer serializer)
            => SetNetRuntime.Default.UseSerializer(serializer);
        ...
        internal static ISerializer Current => SetNetRuntime.Default.Serializer;
        ...
        public static byte[] Serialize<T>(T value) => SetNetRuntime.Default.Serialize(value);
        ...
        public static T Deserialize<T>(byte[] data) => SetNetRuntime.Default.Deserialize<T>(data);
    }
}
