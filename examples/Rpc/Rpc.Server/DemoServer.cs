...
/// <summary>Minimal server-side peer for the demo (RPC needs no per-peer logic).</summary>
...
/// <summary>Minimal server that accepts clients and starts their receive loop; RPC handlers do the rest.</summary>
