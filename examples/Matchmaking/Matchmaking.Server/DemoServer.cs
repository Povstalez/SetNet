...
namespace Matchmaking.Server;

/// <summary>Minimal server-side peer for the demo (matchmaking needs no per-peer logic).</summary>
...
/// <summary>Minimal server that accepts clients and starts their receive loop; Rooms + Matchmaking do the rest.</summary>
