...
- **[Release notes](release-notes/)** — what changed per version and what it means for existing code. Latest: **[1.6.3 — `ReceiveAsync` returns `ValueTask`](release-notes/1.6.3.md)**; before it, **[1.6.2 — the client receive path stops allocating twice per event](release-notes/1.6.2.md)**.
